...
export const mails: Email[] = [ // 变量名 'mails' 意为 '邮件列表'
  {
    ...
    isTrash: false,
    isArchive: false,
    category: [MailCategory.Inbox, MailCategory.Sent],
  },
  {
  ...
  },
  {
    ...
    isTrash: true, // 在垃圾箱中
    isArchive: false,
    category: [MailCategory.Inbox, MailCategory.Sent, MailCategory.Trash],
  },
  {
  ...
  },
  {
    ...
    isTrash: false,
    isArchive: false,
    category: [MailCategory.Inbox, MailCategory.Junk],
  },
];
